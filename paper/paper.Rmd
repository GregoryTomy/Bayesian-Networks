...
>Suppose you find one morning that your car does not start. The starter is turning, but nothing happens. Your problem could by caused by a number of factors. You can hear the starter roll, so the battery must be charged. Thus, you conclude that the the most likely causes are that the fuel was stolen overnight or that the spark plugs are dirty.
